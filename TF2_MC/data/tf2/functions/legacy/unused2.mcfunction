...
execute as @e[type=minecraft:tnt_minecart, nbt={TNtf2use:3}] if entity @s[] at @s run summon minecraft:creeper ~ ~ ~ {Fuse:0}
kill @e[type=minecraft:tnt_minecart, nbt={TNtf2use:1}]