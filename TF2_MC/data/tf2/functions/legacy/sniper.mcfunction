...
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:701}}},scores={rightClicks=1..,attack_cooldown=3..,smg_ammo=1..}] run function tf2:legacy/smg
