#> vdv_iris:find_closest_surface/south/get_distance
#
...
scoreboard players operation $distance vdv_iris = $z0 vdv_iris
scoreboard players operation $distance vdv_iris -= ${z} vdv_iris
scoreboard players operation $distance vdv_iris *= $1000 vdv_iris
scoreboard players operation $distance vdv_iris /= $dz vdv_iris
...
execute if score $distance vdv_iris < $min_distance_to_surface vdv_iris run function vdv_iris:find_closest_surface/south/find_intersection