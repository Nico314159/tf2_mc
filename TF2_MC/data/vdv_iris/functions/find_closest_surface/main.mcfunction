#> vdv_iris:find_closest_surface/main
#
...
#	score $min_distance_to_surface vdv_iris
...
#	score $closest_cuboid_id vdv_iris
...
scoreboard players set $min_distance_to_surface vdv_iris 1733
scoreboard players reset $closest_cuboid_id vdv_iris

execute if score $dx vdv_iris matches 1.. unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/west/main
execute if score $dx vdv_iris matches ..-1 unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/east/main
execute if score $dy vdv_iris matches 1.. unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/bottom/main
execute if score $dy vdv_iris matches ..-1 unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/top/main
execute if score $dz vdv_iris matches 1.. unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/north/main
execute if score $dz vdv_iris matches ..-1 unless score $min_distance_to_surface vdv_iris matches 0 run function vdv_iris:find_closest_surface/south/main