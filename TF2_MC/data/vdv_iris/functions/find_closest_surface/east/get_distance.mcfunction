#> vdv_iris:find_closest_surface/east/get_distance
#
...
execute if score $distance vdv_iris < $min_distance_to_surface vdv_iris run function vdv_iris:find_closest_surface/east/find_intersection