#> vdv_iris:find_closest_surface/north/loop
#
# Determines if the ray hits the current surface
#
# @within vdv_iris:find_closest_surface/north/main
...
execute if score ${z} vdv_iris < $z0 vdv_iris run function vdv_iris:find_closest_surface/north/get_distance
...
execute if score $surfaces vdv_iris matches 1.. run function vdv_iris:find_closest_surface/north/loop