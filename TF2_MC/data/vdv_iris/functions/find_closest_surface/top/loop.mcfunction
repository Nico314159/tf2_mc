#> vdv_iris:find_closest_surface/top/loop
#
# Determines if the ray hits the current surface
#
# @within vdv_iris:find_closest_surface/top/main
...
execute if score ${y} vdv_iris > $y0 vdv_iris run function vdv_iris:find_closest_surface/top/get_distance
