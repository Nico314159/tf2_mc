#> vdv_iris:find_closest_surface/bottom/find_intersection
#
# Get position of the intersection, and see if that position is within the current surface
#
# @within vdv_iris:find_closest_surface/bottom/get_distance
...
# Get y position of the intersection (useful for vdv_iris:find_closest_surface/ray_intersects_with_surface)
