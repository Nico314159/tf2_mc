#> vdv_iris:find_closest_surface/bottom/get_distance
#
...
execute if score $distance vdv_iris < $min_distance_to_surface vdv_iris run function vdv_iris:find_closest_surface/bottom/find_intersection