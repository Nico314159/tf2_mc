execute as @a[advancements={tf:attempt_backstab=true},limit=1] run tag @s add backstabber
execute as @a[advancements={tf:get_hurt=true},limit=1] run tag @s add backstab_victim
...
execute as @a[advancements={tf:attempt_backstab=true}] run advancement revoke @s only tf:attempt_backstab
execute as @a[advancements={tf:get_hurt=true}] run advancement revoke @s only tf:get_hurt
