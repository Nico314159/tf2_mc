...
execute as @e[tag=delete] as @e[type=armor_stand,tag=deployed_stickybomb,sort=nearest,limit=1] at @s run function tf2:legacy/demoman/delete_stickybomb
tag @e remove delete
tag @e[type=chicken] remove tagged
advancement revoke @s only tf2:hit_stickybomb