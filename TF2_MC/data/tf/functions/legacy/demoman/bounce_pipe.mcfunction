...
execute as @s at @s anchored eyes unless block ~1 ~ ~ #vdv_raycast:blocks run function tf:legacy/demoman/tag_pipe
...
execute as @s at @s anchored eyes if entity @s[tag=bounced] unless block ~ ~-0.5 ~ #vdv_raycast:blocks run function tf:legacy/demoman/roll_tag_pipe
...
execute as @s at @s anchored eyes unless entity @s[tag=bounced] unless block ~ ~-1 ~ #vdv_raycast:blocks run function tf:legacy/demoman/tag_pipe
