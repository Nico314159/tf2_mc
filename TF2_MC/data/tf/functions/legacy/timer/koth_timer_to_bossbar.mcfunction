...
# ---------------------------
execute store result bossbar tf:red_timer value run scoreboard players get $red_value timer
execute if score $red_value timer matches 1.. run bossbar set tf:red_timer visible true 
execute if score $red_value timer matches 1.. run bossbar set tf:red_timer players @a
execute if score $red_value timer matches 1.. run scoreboard players set $koth_ended timer 0

execute store result bossbar tf:blu_timer value run scoreboard players get $blu_value timer
execute if score $blu_value timer matches 1.. run bossbar set tf:blu_timer visible true 
execute if score $blu_value timer matches 1.. run bossbar set tf:blu_timer players @a
execute if score $blu_value timer matches 1.. run scoreboard players set $koth_ended timer 0

# set maximum length of bar
# -------------------------
execute store result bossbar tf:red_timer max run scoreboard players get $start timer
execute store result bossbar tf:blu_timer max run scoreboard players get $start timer

# setup timers
# ------------
execute if score $red_seconds timer matches 10..59 run bossbar set tf:red_timer name [{"text":"RED – "},{"score":{"name":"$red_minutes","objective":"timer"}},{"text":":"},{"score":{"name":"$red_seconds","objective":"timer"}},{"text":" remaining"}]
execute if score $red_seconds timer matches 0..9 run bossbar set tf:red_timer name [{"text":"RED – "},{"score":{"name":"$red_minutes","objective":"timer"}},{"text":":0"},{"score":{"name":"$red_seconds","objective":"timer"}},{"text":" remaining"}]

execute if score $blu_seconds timer matches 10..59 run bossbar set tf:blu_timer name [{"text":"BLU – "},{"score":{"name":"$blu_minutes","objective":"timer"}},{"text":":"},{"score":{"name":"$blu_seconds","objective":"timer"}},{"text":" remaining"}]
execute if score $blu_seconds timer matches 0..9 run bossbar set tf:blu_timer name [{"text":"BLU – "},{"score":{"name":"$blu_minutes","objective":"timer"}},{"text":":0"},{"score":{"name":"$blu_seconds","objective":"timer"}},{"text":" remaining"}]
...
# overtime
# --------
execute if score $red_phase timer matches 2 run bossbar set tf:red_timer name [{"text":"RED – Overtime!"}]
execute if score $blu_phase timer matches 2 run bossbar set tf:blu_timer name [{"text":"BLU – Overtime!"}]
...
execute if score $continuation timer matches 70.. run bossbar set tf:red_timer visible false 
execute if score $continuation timer matches 70.. run bossbar set tf:blu_timer visible false 
