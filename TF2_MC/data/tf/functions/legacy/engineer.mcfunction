...
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow"}},scores={gracePeriod=1..13}] run function tf2:legacy/hand_swap
...
# ammo display stuff
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow"}}] unless entity @s[nbt={Inventory: [{Slot: -106b}]}] unless entity @s[nbt={Inventory: [{Slot: 8b}]}] run function tf2:legacy/engineer/fill_clip
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:bow"}}] unless entity @s[nbt={Inventory: [{Slot: -106b}]}] unless entity @s[nbt={Inventory: [{Slot: 8b}]}] run function tf2:legacy/engineer/fill_clip

execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow"}}] unless entity @s[nbt=!{Inventory: [{Slot: -106b, tag:{value:270000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:270000}}]}] run function tf2:legacy/engineer/fill_clip
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:bow"}}] unless entity @s[nbt=!{Inventory: [{Slot: -106b, tag:{value:260000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:260000}}]}] run function tf2:legacy/engineer/fill_clip
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:bow"}]},scores={class=8}] run function tf2:legacy/engineer/fill_clip
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:bow"}]}] run item replace entity @s weapon.offhand with air


# shotgun reload
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow"}]},scores={primaryClip=6}] run function tf2:legacy/hand_swap
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow"}]}] run tag @s add keep_ammo
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow", tag:{ChargedProjectiles:[{Count:1b}]}}]},scores={primaryClip=5}] run function tf2:legacy/hand_swap
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow"}]},scores={class=8,gracePeriod=13..},tag=reloading_shotgun] run function tf2:legacy/engineer/fill_clip
...
# construction PDA
execute as @s if entity @s[nbt={Inventory:[{Slot: -106b, id:"minecraft:warped_fungus_on_a_stick", tag:{CustomModelData: 100}}]}] run function tf2:legacy/engineer/hotbars/construction_pda
