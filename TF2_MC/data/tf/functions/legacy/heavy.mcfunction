...
execute as @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:quick_charge"}]}}]}] run function tf2:legacy/hand_swap
...
# ammo display stuff
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}]}}}] unless entity @s[nbt={Inventory: [{Slot: -106b}]}] unless entity @s[nbt={Inventory: [{Slot: 5b}]}] run function tf2:legacy/heavy/fill_clip
...
# shotgun reload
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}]}}]},scores={secondaryClip=6}] run function tf2:legacy/hand_swap
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}], ChargedProjectiles:[{Count:1b}]}}]},scores={secondaryClip=5}] run function tf2:legacy/hand_swap
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}]}}]},scores={class=6,gracePeriod=13..},tag=reloading_shotgun] run function tf2:legacy/heavy/fill_clip
