...
execute as @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:quick_charge"}]}}]}] run function tf:legacy/hand_swap
...
# shotgun reload
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}]}}]},scores={secondaryClip=6}] run function tf:legacy/hand_swap
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, id:"minecraft:crossbow",tag:{Enchantments:[{id: "minecraft:multishot"}], ChargedProjectiles:[{Count:1b}]}}]},scores={secondaryClip=5}] run function tf:legacy/hand_swap
