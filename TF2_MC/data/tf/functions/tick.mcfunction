...
execute as @a[scores={timeScoped=1..}] run function tf:legacy/damage_scaling
...
execute as @e[type=snowball] run function tf:legacy/demoman/armor_stand_tp
# execute as @e[type=snowball,tag=!bounced] at @s if entity @p[distance=..0.5] run function tf:legacy/explode_pipe

execute as @a if score @s class_change matches 1..9 run function tf:legacy/change_class
...
execute as @a[scores={class=5}] at @s run function tf:legacy/demoman
execute as @a[scores={class=6}] at @s run function tf:legacy/heavy
execute as @a[scores={class=7}] at @s run function tf:legacy/pyro
execute as @a[scores={class=8}] at @s run function tf:legacy/engineer
execute as @a[scores={class=9}] at @s run function tf:legacy/medic
execute as @e[type=minecraft:arrow, nbt={Color:131328}] run kill @s

execute as @a[nbt={Inventory: [{Slot: -106b, id: "minecraft:carrot_on_a_stick", tag:{CustomModelData:101}}]}] run function tf:legacy/demoknight
execute as @a[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:301}}]}] run function tf:legacy/display_cloak
...
execute as @a[scores={class=4}] at @s run function tf:legacy/rocket_launcher
tag @e[type=minecraft:firework_rocket,tag=!deflectable_projectile] add deflectable_projectile

execute positioned 307.30 63.00 58.27 as @a[distance=..4] unless predicate tf:burning if score $allow_modded_commands tf2.main matches 0 run function tf:legacy/extinguish/vanilla_friendly/return
