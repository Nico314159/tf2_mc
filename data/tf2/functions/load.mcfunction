...
data merge storage tf2:maps {0:{name: "test", gamemode: "test", origin: [-500.0f, 1.0f, -500.0f], spawn:{red:[[-487.0f, 1.0f, -487.0f]], blu:[[-513.0f, 1.0f, -513.0f]]}, spawn_time:{red:[5.0f],blu:[5.0f]}, gamestate:{}}}