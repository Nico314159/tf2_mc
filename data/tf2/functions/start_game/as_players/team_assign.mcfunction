...
execute store result score $red_count tf2.var if entity @e[type=#tf2:player_like,tag=tf2.current_batch,scores={tf2.team=1}] 
execute store result score $blu_count tf2.var if entity @e[type=#tf2:player_like,tag=tf2.current_batch,scores={tf2.team=2}]
