...
execute as @e[type=#tf2:player_like,tag=tf2.waiting_room,scores={tf2.queue_type=2,tf2.batch_number=0},limit=24,sort=random] run scoreboard players operation @s tf2.batch_number = $highest_batch_num tf2.var