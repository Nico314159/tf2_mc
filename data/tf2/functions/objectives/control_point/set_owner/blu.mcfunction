...
execute if score @s tf2.gamemode matches 1 at @s run function tf2:objectives/control_point/set_owner/blu/atk_def
execute if score @s[tag=!tf2.multistage] tf2.gamemode matches 2 run function tf2:objectives/control_point/set_owner/blu/symmetric
