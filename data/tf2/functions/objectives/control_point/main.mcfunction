...
scoreboard players operation $input tf2.var > $red_on_point tf2.var
scoreboard players operation $input tf2.var > $blu_on_point tf2.var
function tf2:math/calculate_harmonic_series
