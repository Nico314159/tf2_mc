...
execute store result score $blue_cp_count tf2.var if entity @e[type=marker,tag=tf2.control_point,tag=tf2.current,scores={tf2.team=2}]
...
scoreboard players operation $neutral_cp_count tf2.var -= $blue_cp_count tf2.var
