...
execute as @s[tag=tf2.overtime] run scoreboard players operation $sum tf2.var *= $6 tf2.const
...
execute if score @s tf2.team matches 0 run scoreboard players operation @s tf2.red_progress -= $sum tf2.var
execute if score @s tf2.team matches 0 run scoreboard players operation @s tf2.blu_progress -= $sum tf2.var
