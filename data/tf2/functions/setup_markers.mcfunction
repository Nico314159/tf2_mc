...
execute if score $batch_markers tf2.var < $max_batches tf2.settings run summon minecraft:marker 0 0 0 {Tags:["tf2.batch"],data:{lastPos: [0.0d, 0.0d, 0.0d], queue_type: "", players:{RED:[], BLU:[]}, player_max: 0,  map: {}, game_state: {}}}
