...
execute if score $batch_markers tf2.var < $max_batches tf2.settings run summon minecraft:marker 0 0 0 {Tags:["tf2.batch"],data:{lastPos: [0.0f, 0.0f, 0.0f], queue_type: "", players:{RED:[], BLU:[]}, player_max: 0,  map: {}}}
