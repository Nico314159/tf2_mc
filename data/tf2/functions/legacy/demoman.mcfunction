...
# fire weapons
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:501}}},scores={rightClicks=1..,attack_cooldown=..0,primaryClip=1..}] run function tf2:legacy/demoman/grenade_launcher
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:601}}},scores={rightClicks=1..,attack_cooldown=..0,secondaryClip=1..}] run function tf2:legacy/demoman/stickybomb_launcher
...
execute as @e[type=minecraft:armor_stand,tag=!bounced] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] unless entity @e[type=minecraft:snowball,distance=..2, limit=1, sort=nearest] if entity @a[sort=nearest, limit=1, distance=..1.5] run function tf2:legacy/demoman/explode_pipe
execute as @e[type=minecraft:armor_stand,tag=bounced] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] unless entity @e[type=minecraft:snowball,distance=..2, limit=1, sort=nearest] if entity @a[sort=nearest, limit=1, distance=..1.5] run function tf2:legacy/demoman/explode_pipe_after_bounce

# explode pipes due to timer
execute as @e[type=minecraft:armor_stand,scores={timeExisted=63..},tag=!bounced] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] run function tf2:legacy/demoman/explode_pipe
execute as @e[type=minecraft:armor_stand,scores={timeExisted=63..},tag=bounced] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] run function tf2:legacy/demoman/explode_pipe_after_bounce
...
execute as @e[type=minecraft:armor_stand,scores={timeExisted=2..},tag=!rolling] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] run function tf2:legacy/demoman/tumble_pipe
execute as @e[type=minecraft:armor_stand,tag=!deployed_stickybomb] at @s unless entity @s[tag=!red_stickybomb,tag=!blu_stickybomb] run function tf2:legacy/demoman/tumble_stickybomb
execute as @e[type=minecraft:armor_stand,scores={timeExisted=2..},tag=rolling] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] run function tf2:legacy/demoman/roll_pipe
execute as @e[type=minecraft:snowball] at @s unless entity @s[tag=!red_grenade,tag=!blu_grenade] unless entity @s[tag=bounced, scores={gracePeriod=0..2}] run function tf2:legacy/demoman/bounce_pipe

execute as @e[type=minecraft:snowball,scores={timeExisted=7..}] at @s unless entity @s[tag=!red_stickybomb,tag=!blu_stickybomb] if entity @p[distance=..2] run function tf2:legacy/demoman/bounce_stickybomb
...
execute as @e[type=minecraft:armor_stand, tag=!deployed_stickybomb] at @s unless entity @s[tag=!red_stickybomb,tag=!blu_stickybomb] unless entity @e[type=minecraft:snowball,distance=..2, limit=1, sort=nearest] run function tf2:legacy/demoman/deploy_stickybomb

# arm stickybombs
execute as @e[type=minecraft:armor_stand,tag=unarmed_stickybomb,scores={timeExisted=14..}] run function tf2:legacy/demoman/arm_stickybomb



# ammo display stuff
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:501}}}] unless entity @s[nbt={Inventory: [{Slot: 7b}]}] unless entity @s[nbt={Inventory: [{Slot: 8b}]}] run function tf2:legacy/demoman/fill_clip
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:601}}}] unless entity @s[nbt={Inventory: [{Slot: 7b}]}] unless entity @s[nbt={Inventory: [{Slot: 8b}]}] run function tf2:legacy/demoman/fill_clip

execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:501}}}] unless entity @s[nbt=!{Inventory: [{Slot: 7b, tag:{CustomModelData:230000}}]},nbt=!{Inventory: [{Slot: 7b, tag:{CustomModelData:240000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:230000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:240000}}]}] run function tf2:legacy/demoman/fill_clip
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:601}}}] unless entity @s[nbt=!{Inventory: [{Slot: 7b, tag:{CustomModelData:210000}}]},nbt=!{Inventory: [{Slot: 7b, tag:{CustomModelData:220000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:210000}}]},nbt=!{Inventory: [{Slot: 8b, tag:{CustomModelData:220000}}]}] run function tf2:legacy/demoman/fill_clip
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, tag:{CustomModelData:501}}]},scores={class=5}] run function tf2:legacy/demoman/fill_clip
...
execute as @s at @s if entity @s[nbt={Inventory: [{Slot: -106b, tag:{CustomModelData:601}}]},scores={class=5,gracePeriod=20..},tag=reloading_stickybomb] run function tf2:legacy/demoman/fill_clip
...
execute as @s at @s if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:601}}},scores={gracePeriod=1..20}] run function tf2:legacy/hand_swap
...
execute as @s at @s if entity @s[scores={detonate=1}] run function tf2:legacy/demoman/search_for_stickies
execute as @s at @s if entity @s[scores={rightClicks=1..}] run scoreboard players set @s rightClicks 0
execute as @s at @s if entity @s[scores={activeBombs=9..}] run function tf2:legacy/demoman/detonate_oldest_stickybomb

# prevent players from destroying own team's stickybombs
# execute as @e[tag=deployed_stickybomb,scores={projectileTeam=1}] at @s run kill @e[type=#tf2:projectiles, scores={projectileTeam=1}, distance=0.001..0.25]
# execute as @e[tag=deployed_stickybomb,scores={projectileTeam=2}] at @s run kill @e[type=#tf2:projectiles, scores={projectileTeam=2}, distance=0.001..0.25]

# execute as @e[tag=deployed_stickybomb,scores={projectileTeam=1}] at @s if entity @e[type=#tf2:projectiles, scores={projectileTeam=2}, distance=0.001..0.33, sort=nearest, limit=1] run function tf2:legacy/demoman/delete_stickybomb
# execute as @e[tag=deployed_stickybomb,scores={projectileTeam=2}] at @s if entity @e[type=#tf2:projectiles, scores={projectileTeam=1}, distance=0.001..0.33, sort=nearest, limit=1] run function tf2:legacy/demoman/delete_stickybomb

# delete stickybombs on death
execute if entity @s[tag=isDead] run function tf2:legacy/demoman/delete_all_stickybombs
