...
function tf2:legacy/medic/display_uber

execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{isMedigun:1b}}},scores={rightClicks=1..,uberMeter=800..}] at @s run function tf2:legacy/medic/activate_uber
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{isMedigun:1b}}}] at @s run function tf2:legacy/medic/stock_heal
