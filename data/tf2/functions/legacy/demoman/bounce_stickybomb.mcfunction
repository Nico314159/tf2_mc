...
execute if score @s motion_X matches -4..4 store result entity @s Motion[1] double -0.0003 as @e[type=armor_stand,sort=nearest,limit=1] run function tf2:legacy/demoman/delete_stickybomb
execute if score @s motion_X matches -4..4 store result entity @s Motion[1] double -0.0003 run kill @s
execute if score @s motion_Z matches -4..4 store result entity @s Motion[1] double -0.0003 as @e[type=armor_stand,sort=nearest,limit=1] run function tf2:legacy/demoman/delete_stickybomb
