# execute if entity @s[scores={timeExisted=63..}] run tellraw NicoWill314 "strong explosion (timer)"
# execute if entity @s[scores={timeExisted=..62}] if entity @p[distance=..1] run tellraw NicoWill314 "strong explosion (collision)"
# execute if entity @s[scores={timeExisted=..62}] unless entity @p[distance=..1] run tellraw NicoWill314 "strong explosion (bug)"
...
execute at @s as @a[tag=grenade_damage,distance=..0.279,sort=nearest,limit=1] run scoreboard players set @s custom_damage 20
execute at @s as @a[tag=grenade_damage,distance=0.28..0.559] run scoreboard players set @s custom_damage 18
execute at @s as @a[tag=grenade_damage,distance=0.56..1.119] run scoreboard players set @s custom_damage 16
execute at @s as @a[tag=grenade_damage,distance=1.12..1.679] run scoreboard players set @s custom_damage 14
execute at @s as @a[tag=grenade_damage,distance=1.68..2.239] run scoreboard players set @s custom_damage 12
execute at @s as @a[tag=grenade_damage,distance=2.24..2.8] run scoreboard players set @s custom_damage 10
