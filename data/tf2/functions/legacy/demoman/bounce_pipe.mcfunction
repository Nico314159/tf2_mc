# tellraw @p "If you are seeing this, then tf2:demoman/bounce_pipe has been run" 

# execute as @s at @s anchored eyes unless block ~1 ~ ~ #vdv_raycast:blocks run tellraw @p "hit positive X"
execute as @s at @s anchored eyes unless block ~1 ~ ~ #vdv_raycast:blocks run function tf2:legacy/demoman/tag_pipe
...
execute as @s at @s anchored eyes if entity @s[tag=bounced] unless block ~ ~-0.5 ~ #vdv_raycast:blocks run function tf2:legacy/demoman/roll_tag_pipe
...
execute as @s at @s anchored eyes unless entity @s[tag=bounced] unless block ~ ~-1 ~ #vdv_raycast:blocks run function tf2:legacy/demoman/tag_pipe
