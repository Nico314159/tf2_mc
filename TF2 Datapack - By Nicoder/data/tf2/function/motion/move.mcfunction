...
execute if score $mot.sign_x tf2.var matches 1 run function tf2:__private__/if_else/40
...
scoreboard players operation $mot.distance_tail_x tf2.var /= 1000 tf2.const
execute if score @s tf2.mot_x matches 0 run function tf2:__private__/if_else/41
tag @s add tf2.executing_entity
...
execute if score $mot.sign_y tf2.var matches 1 run function tf2:__private__/if_else/42
...
scoreboard players operation $mot.distance_tail_y tf2.var /= 1000 tf2.const
execute if score @s tf2.mot_y matches 0 run function tf2:__private__/if_else/43
tag @s add tf2.executing_entity
...
scoreboard players operation $mot.distance_tail_z tf2.var /= 1000 tf2.const
execute if score @s tf2.mot_z matches 0 run function tf2:__private__/if_else/45
