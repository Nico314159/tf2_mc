...
execute if score @s tf2.consider_entities matches 1.. run function tf2:__private__/if_else/61
execute if data storage iris:data Shape[] run function tf2:__private__/while_loop/6
execute as @e if score @s iris.id = $id tf2.var run tag @s add tf2.hit_by_projectile