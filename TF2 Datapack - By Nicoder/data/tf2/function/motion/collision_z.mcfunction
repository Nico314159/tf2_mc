...
execute if score $mot.sign_z tf2.var matches 1 run function tf2:__private__/if_else/60
...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/61
