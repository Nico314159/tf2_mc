execute if score $mot.collision_edge_z tf2.var matches 1 run scoreboard players remove $mot.shortest_distance tf2.var 50
...
scoreboard players operation @s tf2.z = $mot.collision_surface_z tf2.var
scoreboard players set __if_else__ tf2.var 0
execute if score $mot.sign_z tf2.var matches 1 run function tf2:__private__/if_else/44
execute if score __if_else__ tf2.var matches 0 run scoreboard players operation @s tf2.z += @s tf2.hitbox_z
scoreboard players operation @s tf2.z -= $mot.sign_z tf2.var
...
scoreboard players operation @s tf2.collision_entity_z = $mot.collision_entity_z tf2.var
...
scoreboard players set $mot.motion_z tf2.var 0
scoreboard players set __if_else__ tf2.var 0
...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/45
