...
execute if score $mot.sign_y tf2.var matches 1 run function tf2:__private__/if_else/46
...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/47
