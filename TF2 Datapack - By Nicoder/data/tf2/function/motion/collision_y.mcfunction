execute if score $mot.collision_edge_y tf2.var matches 1 run scoreboard players remove $mot.shortest_distance tf2.var 50
...
scoreboard players operation @s tf2.collision_entity_y = $mot.collision_entity_y tf2.var
...
scoreboard players set $mot.motion_y tf2.var 0
scoreboard players set __if_else__ tf2.var 0
...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/54
