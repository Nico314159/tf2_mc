...
execute store result score $flight_accel tf2.var run data get storage tf2:summon projectile.weapon.components.minecraft:custom_data.projectile.flight_accel
execute store result score $unreflectable tf2.var run data get storage tf2:summon projectile.weapon.components.minecraft:custom_data.projectile.unreflectable
