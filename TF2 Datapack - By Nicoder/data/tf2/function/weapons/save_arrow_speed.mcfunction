...
execute if score $Settings.show_debug_messages tf2.var matches 1.. run tellraw @a ["",{"text":"arrow speed = "},{"color":"yellow","score":{"name":"$magnitude","objective":"tf2.var"},"type":"score"}]