...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/41
scoreboard players operation @s tf2.ang_vel_x *= $sign_x tf2.var
...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/42
scoreboard players operation @s tf2.ang_vel_y *= $sign_y tf2.var
...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/43
scoreboard players operation @s tf2.ang_vel_z *= $sign_z tf2.var
execute unless score @s tf2.collision_x matches 0 run function tf2:__private__/if_else/44
execute unless score @s tf2.collision_y matches 0 run function tf2:__private__/if_else/45
execute unless score @s tf2.collision_z matches 0 run function tf2:__private__/if_else/46
