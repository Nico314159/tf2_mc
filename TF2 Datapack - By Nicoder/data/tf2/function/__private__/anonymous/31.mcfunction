...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/67
scoreboard players operation @s tf2.ang_vel_x *= $sign_x tf2.var
...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/68
scoreboard players operation @s tf2.ang_vel_y *= $sign_y tf2.var
...
execute if score @s tf2.collision matches 1 run function tf2:__private__/if_else/69
scoreboard players operation @s tf2.ang_vel_z *= $sign_z tf2.var
execute unless score @s tf2.collision_x matches 0 run function tf2:__private__/if_else/70
execute unless score @s tf2.collision_y matches 0 run function tf2:__private__/if_else/71
execute unless score @s tf2.collision_z matches 0 run function tf2:__private__/if_else/72
