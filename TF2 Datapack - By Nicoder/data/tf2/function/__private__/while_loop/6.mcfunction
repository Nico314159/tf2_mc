...
execute if score $mot.sign_x tf2.var matches 1 run function tf2:__private__/if_else/54
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/55
...
execute unless score $mot.motion_x tf2.var matches 0 if score $mot.distance_x tf2.var matches 0.. if score $mot.distance_x tf2.var <= $mot.distance tf2.var run function tf2:__private__/if_else/59
scoreboard players set __if_else__ tf2.var 0
execute if score $mot.sign_y tf2.var matches 1 run function tf2:__private__/if_else/60
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/61
...
execute unless score $mot.motion_y tf2.var matches 0 if score $mot.distance_y tf2.var matches 0.. if score $mot.distance_y tf2.var <= $mot.distance tf2.var run function tf2:__private__/if_else/65
scoreboard players set __if_else__ tf2.var 0
execute if score $mot.sign_z tf2.var matches 1 run function tf2:__private__/if_else/66
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/67
...
execute unless score $mot.motion_z tf2.var matches 0 if score $mot.distance_z tf2.var matches 0.. if score $mot.distance_z tf2.var <= $mot.distance tf2.var run function tf2:__private__/if_else/71
