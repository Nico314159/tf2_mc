...
execute store result score $_count_ tf2.var run clear @s clay_ball[custom_model_data=63000] 0
execute unless score $_count_ tf2.var matches 1 run clear @s clay_ball[custom_model_data=63000]
