...
execute if score $mot.temp_max_z tf2.var >= $mot.geo_min_z tf2.var if score $mot.temp_min_z tf2.var <= $mot.geo_max_z tf2.var if score $mot.temp_max_x tf2.var >= $mot.geo_min_x tf2.var if score $mot.temp_min_x tf2.var <= $mot.geo_max_x tf2.var run function tf2:__private__/if_else/72