...
execute if score $horizontal tf2.var > $y tf2.var run function tf2:__private__/if_else/104
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/105
