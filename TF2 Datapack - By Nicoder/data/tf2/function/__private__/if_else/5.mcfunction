particle dust{color:[1.0,0.2,0.0],scale:0.9} ^ ^ ^ 0 0 0 0 2 force @a[tag=!tf2.self,tag=!iris.target]
...
particle dust{color:[1.0,0.2,0.0],scale:0.3} ^ ^ ^ 0 0 0 0 2 force @a[tag=iris.target]