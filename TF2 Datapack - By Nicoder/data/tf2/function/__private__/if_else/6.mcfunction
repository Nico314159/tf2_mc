particle dust{color:[0.0,0.4,1.0],scale:0.9} ^ ^ ^ 0 0 0 0 2 force @a[tag=!tf2.self,tag=!iris.target]
...
particle dust{color:[0.0,0.4,1.0],scale:0.3} ^ ^ ^ 0 0 0 0 2 force @a[tag=iris.target]