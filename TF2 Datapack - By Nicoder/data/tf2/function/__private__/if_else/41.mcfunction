execute unless score @s tf2.collision_x matches 0 run function tf2:__private__/if_else/38
execute unless score @s tf2.collision_y matches 0 run function tf2:__private__/if_else/39
execute unless score @s tf2.collision_z matches 0 run function tf2:__private__/if_else/40
