...
execute unless score @s tf2.building.target = @s tf2.building.target run function tf2:__private__/if_else/9
...
execute if score @s tf2.health matches ..0 run function tf2:building/sentry/die