...
execute at @s positioned ~ ~1 ~ anchored eyes facing entity @n[tag=tf2.sentry_target] eyes run function tf2:raycast/informational
...
execute at @s positioned ~ ~1 ~ facing entity @n[tag=tf2.sentry_target] eyes run function tf2:raycast/damaging
