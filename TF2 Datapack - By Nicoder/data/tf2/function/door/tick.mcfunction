...
execute if entity @s[tag=tf2.anim_over,tag=!tf2.is_open] run function tf2:door/place_blocks with storage tf2:lookup entity.item.components.minecraft:custom_data.fill
