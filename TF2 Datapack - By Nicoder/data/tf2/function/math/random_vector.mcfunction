...
scoreboard players operation $math_vector_x tf2.var *= $math_vector_x tf2.var
scoreboard players operation $math_vector_y tf2.var = $output_vector_y tf2.var
scoreboard players operation $math_vector_y tf2.var *= $math_vector_y tf2.var
scoreboard players operation $math_vector_z tf2.var = $output_vector_z tf2.var
scoreboard players operation $math_vector_z tf2.var *= $math_vector_z tf2.var
