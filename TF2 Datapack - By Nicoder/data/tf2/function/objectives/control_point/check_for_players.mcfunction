...
execute store result score $red_on_point tf2.var if entity @e[tag=tf2.on_point,tag=tf2.can_cap,scores={tf2.team=1}]
...
execute store result score $blu_on_point tf2.var if entity @e[tag=tf2.on_point,tag=tf2.can_cap,scores={tf2.team=2}]
