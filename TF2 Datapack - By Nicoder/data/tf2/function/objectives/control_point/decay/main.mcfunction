...
execute if score @s[tag=tf2.overtime,scores={tf2.team=1}] tf2.red_progress = @s tf2.capture_threshold as @n[type=marker,tag=tf2.current] run function tf2:timer/cancel_overtime with storage tf2:index
execute if score @s[tag=tf2.overtime,scores={tf2.team=2}] tf2.blu_progress = @s tf2.capture_threshold as @n[type=marker,tag=tf2.current] run function tf2:timer/cancel_overtime with storage tf2:index
...
execute if entity @s[tag=tf2.overtime,scores={tf2.team=0,tf2.red_progress=0,tf2.blu_progress=0}] as @n[type=marker,tag=tf2.current] run function tf2:timer/cancel_overtime with storage tf2:index
