...
data modify storage tf2:lookup points[0].owner set value [{"text":"[","color":"#F5EACB"},{"text":"3210=","color":"#517AB8"}]
...
item modify entity @s contents {"function":"minecraft:set_custom_model_data","floats":{"values":[2],"mode":"replace_all"}}
