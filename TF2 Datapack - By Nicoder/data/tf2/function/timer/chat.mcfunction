...
execute if entity @s[tag=tf2.setup_time] run function tf2:__private__/if_else/34
execute if score __if_else__ tf2.var matches 0 if entity @s[tag=!tf2.overtime] run function tf2:__private__/if_else/35
