...
execute if entity @s[tag=!tf2.overtime] run function tf2:timer/set_value with storage tf2:index
...
execute if score @s[tag=!tf2.setup_time,tag=!tf2.overtime] tf2.timer matches 0 run function tf2:timer/zero with storage tf2:index
