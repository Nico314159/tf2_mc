...
scoreboard players set 135 tf2.const 135
...
scoreboard players set 36000 tf2.const 36000
...
scoreboard players set 99518 tf2.const 99518
...
execute unless score __math__.seed tf2.var matches -2147483648..2147483647 run function tf2:__private__/math_random/setup
