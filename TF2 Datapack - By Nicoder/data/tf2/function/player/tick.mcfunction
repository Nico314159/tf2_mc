...
execute if entity @s[tag=!tf2.dead,y=-45,dy=5] run function tf2:__private__/if_else/77
execute if entity @s[tag=tf2.dead] run function tf2:__private__/if_else/78
...
tag @s add tf2.self
execute if predicate tf2:empty_hand run function tf2:__private__/if_else/81
tag @s remove tf2.self
function tf2:weapons/slot_check
scoreboard players set __if_else__ tf2.var 0
execute if items entity @s weapon.mainhand crossbow[charged_projectiles=[],custom_data~{should_detect_click:true}] run function tf2:__private__/if_else/82
...
execute if score @s tf2.air matches -19 run function tf2:__private__/if_else/84
scoreboard players add @s[predicate=!tf2:submerged] tf2.time_surfaced 1
execute if score @s tf2.time_surfaced matches 40 run function tf2:__private__/if_else/85
...
execute unless entity @a[tag=tf2.search,tag=tf2.uber_source] run function tf2:__private__/if_else/86
...
execute if score @s tf2.team = @e[type=item_display,tag=tf2.resupply,distance=..1.5,limit=1] tf2.team if score $tick_cycle tf2.var matches 0 run function tf2:__private__/if_else/87
