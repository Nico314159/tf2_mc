...
execute if score @s tf2.class matches 1 store result score @s tf2.cloak run data get entity @s Inventory[{Slot:-106b}].components.minecraft:custom_data.attributes.cloak_recharge 20
