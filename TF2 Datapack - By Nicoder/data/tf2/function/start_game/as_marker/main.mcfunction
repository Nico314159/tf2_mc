...
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/37
scoreboard players operation @s tf2.queue_type = @e[type=#tf2:player_like,tag=tf2.current,limit=1] tf2.queue_type
execute if score @s tf2.gamemode matches 1..2 run function tf2:__private__/if_else/38
execute if score @s tf2.gamemode matches 3 run function tf2:__private__/if_else/39
