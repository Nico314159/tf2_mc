...
function tf2:__private__/anonymous/14 with storage tf2:index
...
execute if score @s tf2.gamemode matches 1..2 run function tf2:__private__/if_else/25
execute if score @s tf2.gamemode matches 3 run function tf2:__private__/if_else/26
