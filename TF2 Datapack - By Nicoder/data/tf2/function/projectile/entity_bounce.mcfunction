...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/25
execute unless score @s tf2.collision_entity_y matches 0 run function tf2:__private__/if_else/27
