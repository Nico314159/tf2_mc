...
$execute at @s as @e[distance=..$(radius),tag=!tf2.damage_source,tag=tf2.opponent] unless entity @s[type=!#tf2:player_like,type=!minecraft:item_display] unless entity @s[type=item_display,tag=!tf2.can_be_shot] run function tf2:projectile/wall_check
