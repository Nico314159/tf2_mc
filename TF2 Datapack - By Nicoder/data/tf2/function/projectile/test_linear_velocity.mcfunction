...
tellraw @a ["",{"text":"Test 2: [x, y, z] = [","color":"red","type":"text"},{"score":{"name":"@s","objective":"tf2.mot_x"},"color":"red","type":"score"},{"text":", ","color":"red"},{"score":{"name":"@s","objective":"tf2.mot_y"},"color":"red","type":"score"},{"text":", ","color":"red"},{"score":{"name":"@s","objective":"tf2.mot_z"},"color":"red","type":"score"},{"text":"]","color":"red"}]
function tf2:projectile/linear_velocity_to_quaternion
tellraw @a ["",{"text":"Test 2: [i, j, k, r] = [","color":"red","type":"text"},{"score":{"name":"$input_quaternion_i","objective":"tf2.var"},"color":"red","type":"score"},{"text":", ","color":"red"},{"score":{"name":"$input_quaternion_j","objective":"tf2.var"},"color":"red","type":"score"},{"text":", ","color":"red"},{"score":{"name":"$input_quaternion_k","objective":"tf2.var"},"color":"red","type":"score"},{"text":", ","color":"red"},{"score":{"name":"$input_quaternion_r","objective":"tf2.var"},"color":"red","type":"score"},{"text":"]\n","color":"red"}]
function tf2:projectile/linear_velocity_to_quaternion
