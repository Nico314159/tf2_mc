...
execute positioned as @s as @n[tag=tf2.damage_source] run function tf2:raycast/informational
...
execute store result score $id tf2.var run data get storage iris:output TargetedFace.entity_id
