...
execute summon marker run function tf2:__private__/anonymous/13
...
execute unless entity @s[tag=tf2.hit_by_projectile] if data storage retina:output {Target:"ENTITY"} if score __bool_result__0 tf2.var matches 0 run function tf2:projectile/splash_damage