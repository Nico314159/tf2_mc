...
scoreboard players operation @s tf2.ang_vel_z *= $sign_z tf2.var
execute unless score @s tf2.collision_x matches 0 run function tf2:__private__/if_else/32
execute unless score @s tf2.collision_y matches 0 run function tf2:__private__/if_else/33
execute unless score @s tf2.collision_z matches 0 run function tf2:__private__/if_else/34
