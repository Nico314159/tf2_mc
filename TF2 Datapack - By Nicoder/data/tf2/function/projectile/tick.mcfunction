...
execute if entity @s[tag=tf2.delayed_elasticity] run function tf2:__private__/if_else/27
...
execute if entity @s[tag=tf2.delete] run function tf2:__private__/if_else/28