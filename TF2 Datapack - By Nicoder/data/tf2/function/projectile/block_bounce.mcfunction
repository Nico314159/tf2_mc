...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/22
execute unless score @s[tag=!tf2.has_hit_ground] tf2.collision_y matches 0 run function tf2:projectile/reorient_as_cylinder
