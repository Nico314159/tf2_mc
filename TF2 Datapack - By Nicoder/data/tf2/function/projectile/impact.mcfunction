...
execute as @e if score @s tf2.batch_number = $local tf2.batch_number unless entity @s[gamemode=spectator] run tag @s add tf2.batch
execute as @e[tag=tf2.batch] if score @s tf2.team = @s tf2.team unless score @s tf2.team = $temp tf2.team run tag @s add tf2.opponent
