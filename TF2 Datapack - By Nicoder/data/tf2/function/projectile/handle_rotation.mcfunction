...
execute if score @s tf2.collision matches 1 run scoreboard players operation @s tf2.ang_vel_x *= 800 tf2.const
...
execute if score @s tf2.collision matches 1 run scoreboard players operation @s tf2.ang_vel_y *= 800 tf2.const
