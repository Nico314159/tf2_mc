execute as @e[tag=tf2.origin] at @s summon marker run function tf2:__private__/anonymous/14
...
execute summon item_display run function tf2:__private__/anonymous/16