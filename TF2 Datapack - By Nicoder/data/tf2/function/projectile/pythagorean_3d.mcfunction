execute as @e[tag=tf2.origin] at @s summon marker run function tf2:__private__/anonymous/11
execute at @s summon marker run function tf2:__private__/anonymous/12
...
execute summon item_display run function tf2:__private__/anonymous/13