...
execute store success score @s tf2.red_overtime as @e[type=item_display,tag=tf2.current,tag=tf2.objective] if score @s tf2.red_progress < @s tf2.capture_threshold
