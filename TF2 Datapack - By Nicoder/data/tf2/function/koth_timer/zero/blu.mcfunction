...
execute store success score @s tf2.blu_overtime as @e[type=marker,tag=tf2.current,tag=tf2.objective] if score @s tf2.blu_progress < @s tf2.capture_threshold
tag @e[type=marker,tag=tf2.current,tag=tf2.objective] remove tf2.current
