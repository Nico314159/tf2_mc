...
execute as @e[type=item_display,tag=tf2.control_point,tag=tf2.current] at @s run function tf2:objectives/control_point/lock
...
execute as @a[tag=tf2.current] run function tf2:__private__/anonymous/21
