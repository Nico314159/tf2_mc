...
execute if predicate tf2:class/heavy/is_revving if score $_crossbow_id_ tf2.var matches 61 if score @s tf2.current_slot matches 0 run return run function tf2:__private__/anonymous/0
