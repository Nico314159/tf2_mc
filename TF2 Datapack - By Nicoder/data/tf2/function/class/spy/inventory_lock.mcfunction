...
execute store result score $_count_ tf2.var run clear @s crossbow[custom_model_data=400000000] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[custom_model_data=400000000]
