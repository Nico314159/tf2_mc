...
execute store result score $_count_ tf2.var run clear @s crossbow[custom_data~{key:10}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[custom_data~{key:10}]
...
execute store result score $_count_ tf2.var run clear @s clay_ball[custom_data~{key:11}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s clay_ball[custom_data~{key:11}]
...
execute store result score $_count_ tf2.var run clear @s snowball[custom_data~{key:12}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s snowball[custom_data~{key:12}]
...
execute store result score $_count_ tf2.var run clear @s crossbow[custom_data~{key:13}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[custom_data~{key:13}]
...
execute store result score $_count_ tf2.var run clear @s clay_ball[custom_data~{key:14}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s clay_ball[custom_data~{key:14}]
