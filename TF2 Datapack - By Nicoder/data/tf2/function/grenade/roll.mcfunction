...
scoreboard players operation $input_vector_1_x tf2.var *= 250 tf2.const
...
scoreboard players operation $input_vector_1_y tf2.var *= 250 tf2.const
...
scoreboard players operation $input_vector_1_z tf2.var *= 250 tf2.const
