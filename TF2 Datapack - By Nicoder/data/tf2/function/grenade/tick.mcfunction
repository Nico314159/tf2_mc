...
execute if entity @s[tag=tf2.stuck] run function tf2:__private__/anonymous/29
...
execute if score $hit_object tf2.var matches 1 if entity @s[tag=tf2.has_escaped_player] run function tf2:__private__/anonymous/31
...
execute if score __logic__0 tf2.var matches 1 run function tf2:__private__/if_else/72
...
execute if entity @s[tag=!tf2.stuck] run function tf2:__private__/anonymous/32
