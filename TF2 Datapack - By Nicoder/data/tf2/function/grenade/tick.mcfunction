...
execute if score $hit_object tf2.var matches 1 if entity @s[tag=tf2.has_escaped_player] run function tf2:__private__/if_else/46
...
execute if entity @s[tag=!tf2.stuck] run function tf2:__private__/if_else/54
