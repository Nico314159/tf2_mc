...
execute if entity @s[tag=tf2.stuck] run function tf2:__private__/anonymous/27
...
execute if score $hit_object tf2.var matches 1 if entity @s[tag=tf2.has_escaped_player] run function tf2:__private__/anonymous/29
...
execute if entity @s[tag=!tf2.stuck] run function tf2:__private__/anonymous/30
