...
execute if score $previous_dy tf2.var >= $current_dy tf2.var run function tf2:__private__/if_else/43
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/44
