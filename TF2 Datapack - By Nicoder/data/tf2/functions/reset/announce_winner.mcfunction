...
execute if score $winner tf2.team matches 1 run tellraw @a[tag=tf2.current] ["",{"text":"MATCH ","color":"yellow"},{"text":"| ","color":"white"},{"text":"RED wins!","color":"red","bold":true,"italic":true}]
execute if score $winner tf2.team matches 2 run tellraw @a[tag=tf2.current] ["",{"text":"MATCH ","color":"yellow"},{"text":"| ","color":"white"},{"text":"BLU wins!","color":"blue","bold":true,"italic":true}]
