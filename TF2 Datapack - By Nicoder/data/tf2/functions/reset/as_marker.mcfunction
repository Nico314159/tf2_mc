...
execute if score @s tf2.gamemode matches 1..2 run function tf2:timer/hide with storage tf2:index
execute if score @s tf2.gamemode matches 3 run function tf2:koth_timer/hide with storage tf2:index
