...
execute as @a[tag=tf2.is_playing,tag=!tf2.dead] at @s if entity @s[y=-45,dy=5] run function tf2:__private__/anonymous/4
execute as @e[type=#tf2:player_like,tag=tf2.is_playing,tag=!tf2.dead,scores={tf2.health=..0}] run function tf2:death
execute as @e[type=#tf2:player_like,tag=tf2.dead] run function tf2:__private__/anonymous/5
...
execute as @e[type=#tf2:player_like,tag=tf2.is_playing,gamemode=!spectator] at @s run function tf2:__private__/anonymous/6
