...
execute at @s anchored eyes run summon firework_rocket ^-0.2236 ^-0.05715 ^-0.447675 {Life:false,LifeTime:2147483647,ShotAtAngle:true,NoGravity:true,Motion:[0.0,0.0,0.0],Tags:["tf2.new"]}
