...
execute store result storage tf2.__temp__:summon projectile.speed double 0.0000020833 run data get storage tf2.__temp__:summon projectile.speed 1000
function tf2:__private__/anonymous/6 with storage tf2.__temp__:summon projectile
...
execute at @s anchored eyes run function tf2:__private__/anonymous/7 with storage tf2.__temp__:summon projectile
