...
execute if score @s[tag=!tf2.said_death_msg] tf2.health matches 1.. run playsound tf2:ding.hit player @a[tag=retina.executing,predicate=!tf2:holding_melee] ~ ~ ~ 0.9 1 0.05