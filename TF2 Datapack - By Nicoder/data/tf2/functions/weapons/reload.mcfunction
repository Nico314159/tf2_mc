...
execute store result score $_reloadType_ tf2.var run data get entity @s SelectedItem.components.minecraft:custom_data.controls.reload
...
execute if score @s tf2.consecutive_reload matches 0 store result score $_reloadDelay_ tf2.var run data get entity @s SelectedItem.components.minecraft:custom_data.attributes.reloadDelay[0] 20000
execute if score @s tf2.consecutive_reload matches 1 store result score $_reloadDelay_ tf2.var run data get entity @s SelectedItem.components.minecraft:custom_data.attributes.reloadDelay[1] 20000
