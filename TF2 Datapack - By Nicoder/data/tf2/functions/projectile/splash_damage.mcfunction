...
tellraw @a[tag=tf2.current] ["",{"selector":"@a[tag=tf2.origin]","type":"selector"},{"text":" blew up "},{"selector":"@s","type":"selector"},{"text":" with "},{"type":"nbt","source":"entity","nbt":"SelectedItem.components.minecraft:custom_name","interpret":true,"entity":"@a[tag=tf2.origin]"}]
