...
tag @e[type=#tf2:player_like,distance=..1.5,tag=!tf2.unable_to_cap] add tf2.on_point
...
execute if score $red_on_point tf2.var matches 1.. if score $blu_on_point tf2.var matches 1.. run return run tag @s add tf2.contested
function tf2:objectives/control_point/main