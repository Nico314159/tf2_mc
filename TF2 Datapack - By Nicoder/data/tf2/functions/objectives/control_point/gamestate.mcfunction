...
execute if score $red_cp_count tf2.var = @s tf2.index if score @s[tag=!tf2.multistage] tf2.gamemode matches 2 run scoreboard players set $winner tf2.var 1
execute if score $blu_cp_count tf2.var = @s tf2.index if score @s[tag=!tf2.multistage] tf2.gamemode matches 1..2 run scoreboard players set $winner tf2.var 2
execute if score $winner tf2.var = $winner tf2.var unless score @s tf2.timer matches ..-1 run function tf2:reset/announce_winner
