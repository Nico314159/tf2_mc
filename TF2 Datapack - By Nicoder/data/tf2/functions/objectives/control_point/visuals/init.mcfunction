...
execute if entity @s[tag=tf2.locked] run function tf2:__private__/if_else/29
execute if score __if_else__ tf2.var matches 0 run function tf2:__private__/if_else/30
...
execute if score @s[tag=tf2.letter] tf2.index matches 20 run data modify storage tf2.__temp__:lookup points[0].extra set value "[{\"text\":\"3210|]\",\"color\":\"gray\"},{\"text\":\"|21C$#\",\"color\":\"black\"}]"
execute if score @s[tag=tf2.letter] tf2.index matches 30 run data modify storage tf2.__temp__:lookup points[0].extra set value "[{\"text\":\"3210|]\",\"color\":\"gray\"},{\"text\":\"|21D$#\",\"color\":\"black\"}]"
execute if score @s[tag=tf2.letter] tf2.index matches 40 run data modify storage tf2.__temp__:lookup points[0].extra set value "[{\"text\":\"3210|]\",\"color\":\"gray\"},{\"text\":\"|21E$#\",\"color\":\"black\"}]"
