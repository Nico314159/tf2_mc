#> tf2:objectives/control_point/visuals/capture_progress/blu/main
#
...
#   score @s tf2.team
#       Which team owns the control point. Determines whether or not to flicker the background (only flickers if BLU is taking RED's point rather than an unowned point).
...
function tf2:__private__/switch_case/126
