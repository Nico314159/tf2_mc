...
execute if score $i tf2.var >= $y tf2.var if score $line tf2.var matches 1..3 unless score $line tf2.var matches 2 run function tf2:__private__/if_else/44
execute if score $i tf2.var >= $horizontal tf2.var if score $line tf2.var matches 2..4 unless score $line tf2.var matches 3 run function tf2:__private__/if_else/45
