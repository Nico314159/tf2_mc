...
execute if score $batch_markers tf2.var < $Settings.max_batches tf2.var run function tf2:__private__/if_else/1
...
execute as @e[type=marker,tag=tf2.batch] unless score @s tf2.batch_number = @s tf2.batch_number run function tf2:__private__/anonymous/2
