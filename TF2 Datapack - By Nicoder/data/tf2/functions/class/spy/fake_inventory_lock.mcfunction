...
execute store result score $_count_ tf2.var run clear @s crossbow[minecraft:custom_data~{fake_slot:"primary"}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[minecraft:custom_data~{fake_slot:"primary"}]
execute unless score $_count_ tf2.var matches 1 run function tf2:class/spy/fake_primary
function tf2:class/spy/fake_secondary
execute store result score $_count_ tf2.var run clear @s crossbow[minecraft:custom_data~{fake_slot:"secondary"}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[minecraft:custom_data~{fake_slot:"secondary"}]
execute unless score $_count_ tf2.var matches 1 run function tf2:class/spy/fake_secondary
function tf2:class/spy/fake_melee
execute store result score $_count_ tf2.var run clear @s crossbow[minecraft:custom_data~{fake_slot:"melee"}] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[minecraft:custom_data~{fake_slot:"melee"}]
execute unless score $_count_ tf2.var matches 1 run function tf2:class/spy/fake_melee
