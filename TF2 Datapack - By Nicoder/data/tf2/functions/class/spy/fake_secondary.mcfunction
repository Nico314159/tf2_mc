execute store result score $fake_CMD tf2.var run data get entity @s Inventory[{Slot:1b}].components.minecraft:custom_model_data 10
...
scoreboard players add $fake_CMD tf2.var 2
