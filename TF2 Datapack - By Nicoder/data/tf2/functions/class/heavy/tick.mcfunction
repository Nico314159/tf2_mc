...
attribute @s[predicate=tf2:class/heavy/is_revving] minecraft:generic.movement_speed modifier add 736c6f77-7768-696c-6572-657676696e67 "slowwhilerevving" -0.5 multiply
...
scoreboard players add @s[predicate=tf2:class/heavy/is_revving] tf2.time_revved 1
