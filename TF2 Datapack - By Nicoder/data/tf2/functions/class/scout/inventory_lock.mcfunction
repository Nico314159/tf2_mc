...
execute store result score $_count_ tf2.var run clear @s crossbow[custom_model_data=31000] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[custom_model_data=31000]
...
execute store result score $_count_ tf2.var run clear @s crossbow[custom_model_data=32000] 0
execute unless score $_count_ tf2.var matches 1 run clear @s crossbow[custom_model_data=32000]
...
execute store result score $_count_ tf2.var run clear @s snowball[custom_model_data=33000] 0
execute unless score $_count_ tf2.var matches 1 run clear @s snowball[custom_model_data=33000]
