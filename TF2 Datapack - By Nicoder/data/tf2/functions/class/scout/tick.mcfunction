...
execute unless score @s tf2.last_slot = @s tf2.current_slot run function tf2:__private__/if_else/22
...
execute if score @s tf2.elytra_detect matches 1.. run function tf2:__private__/if_else/23
