...
function tf2:__private__/anonymous/12 with storage tf2.__temp__:index
...
data remove storage tf2.__temp__:summon entity
data modify storage tf2.__temp__:summon pickups set from entity @s data.map.pickups
execute if data storage tf2.__temp__:summon pickups[] run function tf2:__private__/while_loop/2
data remove storage tf2.__temp__:summon entity
data modify storage tf2.__temp__:summon resupply set from entity @s data.map.resupply_cabinets.red
data modify storage tf2.__temp__:summon resupply append from entity @s data.map.resupply_cabinets.blu[]
...
execute if score $comp_queue_length tf2.var matches 12.. run function tf2:__private__/if_else/14
...
execute if score @s tf2.gamemode matches 1..2 run function tf2:__private__/if_else/20
execute if score @s tf2.gamemode matches 3 run function tf2:__private__/if_else/21
