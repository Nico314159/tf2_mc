...
execute unless score @a[tag=tf2.recipient,limit=1] tf2.class matches 1 run return 1
scoreboard players operation $add_amount tf2.var = $percent tf2.var
scoreboard players operation $add_amount tf2.var *= 600 tf2.const
scoreboard players add $add_amount tf2.var 99
scoreboard players operation $add_amount tf2.var /= 100 tf2.const
scoreboard players operation @a[tag=tf2.recipient] tf2.cloak += $add_amount tf2.var
scoreboard players operation @a[tag=tf2.recipient] tf2.cloak < 600 tf2.const