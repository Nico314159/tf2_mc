...
function tf2:koth_timer/display with storage tf2:index
execute if score @s tf2.team matches 0 run return 0
execute if score @s[scores={tf2.red_overtime=0},tag=!tf2.ended] tf2.team matches 1 run function tf2:koth_timer/update/red with storage tf2:index
execute if score @s[scores={tf2.blu_overtime=0},tag=!tf2.ended] tf2.team matches 2 run function tf2:koth_timer/update/blu with storage tf2:index
