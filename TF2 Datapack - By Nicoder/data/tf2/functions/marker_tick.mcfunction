...
execute if entity @s[tag=tf2.batch] run function tf2:__private__/anonymous/17
execute if entity @s[tag=tf2.spawn_door] run function tf2:spawn/protect with entity @s data