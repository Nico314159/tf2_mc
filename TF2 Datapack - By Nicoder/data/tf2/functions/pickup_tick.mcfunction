...
execute store result entity @s[scores={tf2.respawn_timer=0}] Item.components.minecraft:custom_model_data int 1 run scoreboard players get @s tf2.model_number
...
execute if entity @s[tag=tf2.health_pack] run function tf2:__private__/if_else/39
execute if entity @s[tag=tf2.ammo_pack] run function tf2:__private__/if_else/40
scoreboard players set @s tf2.respawn_timer 200
data modify entity @s Item.components.minecraft:custom_model_data set value -1b
