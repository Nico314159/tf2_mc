...
execute store result entity @s Rotation[0] float 5.73 run scoreboard players get @s tf2.rotation
...
execute at @s as @a[distance=..1.25,limit=1,sort=nearest,tag=!tf2.ineligible] run tag @s add tf2.recipient
