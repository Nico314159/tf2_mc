...
execute if entity @s[tag=tf2.health_pack] run function tf2:__private__/if_else/38
execute if entity @s[tag=tf2.ammo_pack] run function tf2:__private__/if_else/39
