...
execute store result score @s tf2.door.accel run data get storage tf2:lookup entity.item.components.minecraft:custom_data.goal_positions.closed[1] 10000
