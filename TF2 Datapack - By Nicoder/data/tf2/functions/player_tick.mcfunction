execute if entity @s[tag=!tf2.dead,y=-45,dy=5] run function tf2:__private__/if_else/39
execute if entity @s[tag=!tf2.dead,scores={tf2.health=..0}] run function tf2:death
execute if entity @s[tag=tf2.dead] run function tf2:__private__/if_else/40
...
tag @s add tf2.self
execute if predicate tf2:empty_hand run function tf2:__private__/if_else/43
tag @s remove tf2.self
execute if predicate tf2:unloaded_crossbow run function tf2:__private__/if_else/44
