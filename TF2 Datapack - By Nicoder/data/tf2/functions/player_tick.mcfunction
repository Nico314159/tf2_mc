...
execute if entity @s[tag=!tf2.dead,y=-45,dy=5] run function tf2:__private__/if_else/36
execute if entity @s[tag=!tf2.dead,scores={tf2.health=..0}] run function tf2:death
execute if entity @s[tag=tf2.dead] run function tf2:__private__/if_else/37
...
tag @s add tf2.self
execute if predicate tf2:empty_hand run function tf2:__private__/if_else/40
tag @s remove tf2.self
function tf2:weapons/slot_check
execute if predicate tf2:unloaded_crossbow run function tf2:__private__/if_else/41
...
execute if entity @s[scores={tf2.class=0},predicate=tf2:active_offhand] run function tf2:__private__/if_else/42
...
execute if score @s tf2.air matches -19 run function tf2:__private__/if_else/45
scoreboard players add @s[predicate=!tf2:submerged] tf2.time_surfaced 1
execute if score @s tf2.time_surfaced matches 40 run function tf2:__private__/if_else/46
...
execute if score @s tf2.team = @e[type=item_display,tag=tf2.resupply,distance=..1.5,limit=1] tf2.team if score $tick_cycle tf2.var matches 0 run function tf2:__private__/if_else/47
