...
execute if score @s tf2.air matches -19 run function tf2:__private__/if_else/43
scoreboard players add @s[predicate=!tf2:submerged] tf2.time_surfaced 1
execute if score @s tf2.time_surfaced matches 40 run function tf2:__private__/if_else/44
