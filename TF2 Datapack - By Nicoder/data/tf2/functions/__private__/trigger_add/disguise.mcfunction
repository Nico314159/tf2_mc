...
execute unless score $error tf2.var matches 1.. run function tf2:class/spy/apply_disguise
execute if score $error tf2.var matches 1.. run tag @s remove tf2.disguised
