...
execute as @e[type=area_effect_cloud,tag=tf2.new] run function tf2:__private__/anonymous/16
execute as @e[type=item,tag=tf2.new] run function tf2:__private__/anonymous/18
