...
execute store result score $visible tf2.var run data get storage tf2.__temp__:summon entity.data.visible
execute if score $visible tf2.var matches 1.. run tag @s add tf2.visible
