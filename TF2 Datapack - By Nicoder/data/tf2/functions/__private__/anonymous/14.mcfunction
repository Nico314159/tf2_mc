...
execute store result storage tf2.__temp__:summon entity.data.mx float 0.125 run data get storage tf2.__temp__:summon entity.data.dx
execute store result storage tf2.__temp__:summon entity.data.my float 0.125 run data get storage tf2.__temp__:summon entity.data.dy
execute store result storage tf2.__temp__:summon entity.data.mz float 0.125 run data get storage tf2.__temp__:summon entity.data.dz
