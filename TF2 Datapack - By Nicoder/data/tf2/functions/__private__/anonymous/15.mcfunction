...
execute store result score $direct_tp tf2.var run data get storage tf2.__temp__:summon entity.data.direct_tp
execute unless score $direct_tp tf2.var matches 1.. run tag @s add tf2.visible
execute unless score $direct_tp tf2.var matches 1.. run data modify storage tf2.__temp__:summon entity.data.direct_tp set value "~ ~ ~"
...
execute store result storage tf2.__temp__:summon entity.data.opp_team int 1 run scoreboard players get $opp_team tf2.var
