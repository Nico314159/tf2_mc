execute store result score $_damage_ tf2.var run data get entity @s item.tag.attributes.damage.base
execute store result score $_selfDamage_ tf2.var run data get entity @s item.tag.attributes.explosion.selfDamage
