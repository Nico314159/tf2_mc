execute positioned ~-0.95 ~-0.95 ~-0.95 as @e[type=#tf2:player_like,tag=tf2.enemy,dx=0,tag=!__self__] positioned ~0.9 ~0.9 ~0.9 if entity @s[dx=0] positioned ~0.05 ~0.05 ~0.05 run function tf2:__private__/raycast_simple/collide/0
