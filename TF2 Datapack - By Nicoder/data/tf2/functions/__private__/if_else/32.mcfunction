...
execute if entity @s[distance=  ..5] run particle dust 1.0 0.2 0.0 0.25 ^ ^ ^ 0 0 0 0 2 force @s
execute if entity @s[distance=5..50] run particle dust 1.0 0.2 0.0 0.50 ^ ^ ^ 0 0 0 0 2 force @s
