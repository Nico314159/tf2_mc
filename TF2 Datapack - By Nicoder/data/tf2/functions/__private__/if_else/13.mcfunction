...
execute store result score $_isHeadshot_ tf2.var run data get storage retina:output HitEntityHead
execute if score $_isHeadshot_ tf2.var matches 1.. run scoreboard players operation $_multiplier_ tf2.var *= 3 tf2.const
